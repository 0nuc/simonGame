...
// assertTrue(playerNameController.playerNameFields.getChildren().get(0)
// instanceof TextField);
// assertEquals("Prénom du joueur 1",
// ((TextField)
// playerNameController.playerNameFields.getChildren().get(0)).getPromptText());
// }
...
// ((TextField)
// playerNameController.playerNameFields.getChildren().get(0)).setText("Alice");
// ((TextField)
// playerNameController.playerNameFields.getChildren().get(1)).setText("Bob");
